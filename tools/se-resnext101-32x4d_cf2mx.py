...
mx_prefix   = 'se-resnext101-32x4d'
mx_sym      = 'se-resnext101-32x4d-symbol.json'
cf_model    = 'se-resnext101-32x4d.caffemodel'
cf_prototxt = 'deploy_se-resnext101-32x4d.prototxt'
...
def convert_name(layer_name):
    ...
    if 'conv2' in layer_name:
        name = 'seresx' + layer_name[6] + layer_name[7:]
    elif 'conv3' in layer_name:
        name = 'seresx' + str(3+ int(layer_name[6])) + layer_name[7:]
    elif 'conv4' in layer_name:
        name = 'seresx' + str(7+ int(layer_name.split('_')[1])) + '_' + '_'.join(layer_name.split('_')[2:])
    elif 'conv5' in layer_name:
        name = 'seresx' + str(30 + int(layer_name[6])) + layer_name[7:]
    return name
