...
mx_prefix   = 'resnet269-v2'
mx_sym      = 'resnet269-v2-symbol.json'
cf_model    = 'resnet269-v2.caffemodel'
cf_prototxt = 'deploy_resnet269-v2.prototxt'
...
for layer_name in layer_names:
    ...
    elif '_bn' in layer_name:    #res1_conv1_bn
        convert_params_bn(layer_name)
    elif '_scale' in layer_name:     #res1_conv1_scale
        convert_params_scale(layer_name)

    else:
        if '_conv' in layer_name:      #res1_conv1
