...
mx_prefix   = 'resnext101-64x4d'
mx_sym      = 'resnext101-64x4d-symbol.json'
cf_model    = 'resnext101-64x4d.caffemodel'
cf_prototxt = 'deploy_resnext101-64x4d.prototxt'
...
for layer_name in layer_names:
    ...
    elif '_bn' in layer_name:    #resx1_conv1_bn
        convert_params_bn(layer_name)
    elif '_scale' in layer_name:     #resx1_conv1_scale
        convert_params_scale(layer_name)

    else:
        if '_conv' in layer_name:    # resx1_conv1
