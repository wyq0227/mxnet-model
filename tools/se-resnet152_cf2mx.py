...
mx_prefix   = 'se-resnet152'
mx_sym      = 'se-resnet152-symbol.json'
cf_model    = 'se-resnet152.caffemodel'
cf_prototxt = 'deploy_se-resnet152.prototxt'
...
def convert_name(layer_name):
    ...
    if 'conv2' in layer_name:
        ...
        name = 'seres' + str(11+ int(layer_name.split('_')[1])) + '_' + '_'.join(layer_name.split('_')[2:])
    elif 'conv5' in layer_name:
        name = 'seres' + str(47 + int(layer_name[6])) + layer_name[7:]
    return name
