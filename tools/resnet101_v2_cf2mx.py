...
mx_prefix   = 'resnet101-v2'
mx_sym      = 'resnet101-v2-symbol.json'
cf_model    = 'resnet101-v2.caffemodel'
cf_prototxt = 'deploy_resnet101-v2.prototxt'
...
for layer_name in layer_names:
    ...
    elif '_scale' in layer_name:     #res2_conv1_scale
