...
mx_prefix   = 'se-resnet50'
mx_sym      = 'se-resnet50-symbol.json'
cf_model    = 'se-resnet50.caffemodel'
cf_prototxt = 'deploy_se-resnet50.prototxt'
...
def convert_name(layer_name):
    ...
    if 'conv2' in layer_name:
        ...
        name = 'seres' + str(7+ int(layer_name[6])) + layer_name[7:]
    elif 'conv5' in layer_name:
        name = 'seres' + str(13 + int(layer_name[6])) + layer_name[7:]
    return name
