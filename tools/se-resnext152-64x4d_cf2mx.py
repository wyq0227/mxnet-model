...
mx_prefix   = 'se-resnext152-64x4d'
mx_sym      = 'se-resnext152-64x4d-symbol.json'
cf_model    = 'se-resnext152-64x4d.caffemodel'
cf_prototxt = 'deploy_se-resnext152-64x4d.prototxt'
...
for layer_name in layer_names:
    ...
    if layer_name == 'input':
        ...
        if 'resx' in layer_name:
            new_name = layer_name.replace('resx', 'seresx')
        else:
            new_name = layer_name
        new_name = new_name.split('_bn')[0]
        ...
        if 'resx' in layer_name:
            ...
            new_name = layer_name
        new_name = new_name.split('_scale')[0]
