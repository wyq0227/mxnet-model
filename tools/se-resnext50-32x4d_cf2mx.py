...
mx_prefix   = 'se-resnext50-32x4d'
mx_sym      = 'se-resnext50-32x4d-symbol.json'
cf_model    = 'se-resnext50-32x4d.caffemodel'
cf_prototxt = 'deploy_se-resnext50-32x4d.prototxt'
...
def convert_name(layer_name):
    ...
    if 'conv2' in layer_name:
        ...
        name = 'seresx' + str(7+ int(layer_name[6])) + layer_name[7:]
    elif 'conv5' in layer_name:
        name = 'seresx' + str(13 + int(layer_name[6])) + layer_name[7:]
    return name
